Function && Function.prototype && Function.prototype.bind && (/(MSIE ([6789]|10|11))|Trident/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(), window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || function(t) {
            ...
            if (n) e.push(n[2]);
                ...
                u.charset = "utf-8", u.timeout = 120, i.nc && u.setAttribute("nonce", i.nc), u.src = function(t) {
                    return i.p + "js/" + ({
                        ...
                        0: "9f954c9c92ade4ce690c15a81c5566e0",
                        2: "606759a962e7a526d21a4a6d8cf30d4b",
                        3: "d2f864f87f544dc0c11d7d712a191c1f",
                        4: "2cec05d6b63ccac0ac3ef9ee84e5479c",
                        5: "8154d13825a7c656f1592df3b1970bf3",
                        6: "a7991bb824d62c8d5038ddd875db8389",
                        7: "0f2977b5b9778cf00d0c90532a8b279b",
                        8: "495a42551da1e5c4c5171224e18a5a07"
                    }[t] + ".js"
                }(t), s = function(e) {
    ...
    var r = n(8),
        ...
        c = ["https://platform.twitter.com", "https://localhost.twitter.com", /^https:\/\/ton\.smf1\.twitter\.com\/syndication-internal\/embed-iframe\/[0-9A-Za-z_-]+\/app/],
        d = function(t, e) {
    ...
    t.exports = {
        ...
        settingsScribe: function(t) {
            var e = t || [];
            return e.unshift("i/jot/embeds"), h(f(), e)
        },
        timeline: function(t) {
            var e = t || [];
    ...
    t.exports = function(t, e, n) {
        ...
        return t = t || [], e = e || {}, c = "ƒ(" + t.join(", ") + ", target, [options]);",
            function() {
                var d, l, f, h, p = Array.prototype.slice.apply(arguments, [0, t.length]),
                    m = Array.prototype.slice.apply(arguments, [t.length]);
                return m.forEach(function(t) {
                    t && (t.nodeType !== Node.ELEMENT_NODE ? u.isType("function", t) ? d = t : u.isType("object", t) && (l = t) : f = t)
                }), p.length !== t.length || 0 === m.length ? (d && u.async(function() {
                    d(!1)
                }), r.reject(new Error("Not enough parameters. Expected: " + c))) : f ? (l = u.aug({}, l || {}, e), t.forEach(function(t) {
                    l[t] = p.shift()
                }), a.asBoolean(l.dnt) && i.setOn(), h = s.getExperiments().then(function(t) {
    ...
    t.exports = {
        ...
        isHorizonTimelineVariantSupported: a,
        isHorizonTimelineEnabled: function(t, e) {
            var n = i.getHostname(r.rootDocumentLocation()),
                u = t && t[s] && t[s].bucket,
                c = u && -1 !== u.indexOf(n),
                d = t && t[o] && "treatment" === t[o].bucket,
                l = a(e);
            return !c && d && l
        }
    }
    ...
    var r = n(58),
        ...
        d = 2083,
        l = [],
        f = i.url(o.CLIENT_EVENT_ENDPOINT, {
            dnt: 0,
            l: ""
        }),
        h = encodeURIComponent(f).length;

    function p(t, e, n, r, i) {
        var d = !u.isObject(t),
            l = !!e && !u.isObject(e);
        if (!d && !l) return c && c(arguments), s.getExperiments().then(function(s) {
    ...
    t.exports = {
        version: "1c23387b1f70c:1664388199485"
    }
}, function(t, e, n) {
    var r, i = n(10),
        o = n(4),
    ...
    r = function() {
        ...
        function N(e, n, r) {
            n.constructor === e.constructor && r === y && n.constructor.resolve === b ? function(t, e) {
                e._state === T ? I(t, e._result) : e._state === S ? L(t, e._result) : j(e, void 0, function(e) {
                    return P(t, e)
                }, function(e) {
                    return L(t, e)
                })
            }(e, n) : r === A ? (L(e, A.error), A.error = null) : void 0 === r ? I(e, n) : t(r) ? function(t, e, n) {
                o(function(t) {
                    var r = !1,
                        i = function(t, e, n, r) {
                            try {
        ...
        function P(t, e) {
            var n, r;
            t === e ? L(t, new TypeError("You cannot resolve a promise with itself")) : (r = typeof(n = e), null === n || "object" !== r && "function" !== r ? I(t, e) : N(t, e, R(e)))
        }
        ...
        function L(t, e) {
            t._state === x && (t._state = S, t._result = e, o(C, t))
        }
        ...
        function D(e, n, r, i) {
            ...
            if (o) {
                if ((s = function(t, e) {
                    ...
                    }(r, i)) === A ? (c = !0, a = s.error, s.error = null) : u = !0, n === s) return void L(n, new TypeError("A promises callback cannot return that same promise."))
            } else s = i, u = !0;
            n._state !== x || (o && u ? P(n, s) : c ? L(n, a) : e === T ? I(n, s) : e === S && L(n, s))
        }
        var z = 0;
        ...
        var M = function() {
                ...
                return t.prototype._enumerate = function(t) {
                    ...
                    var r = this.promise;
                    r._state === x && (this._remaining--, t === S ? L(r, n) : this._result[e] = n), 0 === this._remaining && I(r, this._result)
    ...
    t.exports = function(t, e, n, h) {
        var p, m = s.get(t.dataSource.id),
            v = i.isHorizonTimelineEnabled(h, m);
        return a(m), v ? (p = r.createElement("div"), new o(c, u, f.TIMELINE, t, e, n, {
            sandboxWrapperEl: p
        })) : new o(l, d, f.TIMELINE, t, e, n)
    }
}, function(t, e, n) {
    var r = n(4),
        i = n(16),
    ...
    t.exports = {
        tweetButtonHtmlPath: "/widgets/tweet_button.7dae38096d06923d683a2a807172322a.{{lang}}.html",
        followButtonHtmlPath: "/widgets/follow_button.7dae38096d06923d683a2a807172322a.{{lang}}.html",
        hubHtmlPath: "/widgets/hub.html",
        widgetIframeHtmlPath: "/widgets/widget_iframe.7dae38096d06923d683a2a807172322a.html",
    ...
    t.exports = function(t, e, n, i, o) {
        ...
        r.clientEvent(s, a, void 0, void 0, u)
    }
}, , , , , , , , , function(t, e, n) {
    var r, i = n(2),
        o = n(4),
    ...
    function g(t, e) {
        var n, i;
        return t = (t = t || r.body).length ? f.toRealArray(t) : [t], c.pause(), i = function(t, e) {
    ...
    t.exports = a.couple(n(61), function(t) {
    ...
    t.exports = [n(115), n(121), n(129), n(131), n(133), n(150), n(152)]
}, function(t, e, n) {
    var r = n(11),
        i = n(5),
        o = n(0),
    ...
    t.exports = c.couple(n(61), function(t) {
    ...
    var r = n(83),
        ...
        o = n(20);
    t.exports = function(t) {
        return o.getHorizonSettings().then(function(e) {
            var n, o = e.features,
                s = e.sessionId;
            o && (n = o[i.HORIZON_TIMELINE_EXP_KEY]) && n.bucket && i.isHorizonTimelineVariantSupported(t) && r(i.HORIZON_TIMELINE_EXP_KEY, n.bucket, n.version, {}, s)
        })
    }
}, function(t, e, n) {
    var r = n(2);
