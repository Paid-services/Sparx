...
var Sentry = function(t) {
    ...
    }(c || (c = {})), (a = t.Severity || (t.Severity = {})).Fatal = "fatal", a.Error = "error", a.Warning = "warning", a.Log = "log", a.Info = "info", a.Debug = "debug", a.Critical = "critical",
        function(t) {
    ...
    function M(t) {
        try {
            for (var n = t, r = [], e = 0, i = 0, o = " > ".length, u = void 0; n && e++ < 5 && !("html" === (u = A(n)) || e > 1 && i + r.length * o + u.length >= 80);) r.push(u), i += u.length, n = n.parentNode;
    ...
    var q = Date.now(),
        ...
        H = function() {
            ...
            var t, n;
            return O().performance && void 0 === performance.timeOrigin && (performance.timeOrigin = performance.timing && performance.timing.navigationStart || q), O().performance || L
        }();
    ...
    var $ = O(),
        ...
        J = function() {
            ...
            return t.prototype.disable = function() {
                ...
                this.t && I(function() {
                    $.console.log(G + "[Log]: " + t.join(" "))
                })
            }, t.prototype.warn = function() {
                for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                this.t && I(function() {
                    $.console.warn(G + "[Warn]: " + t.join(" "))
                })
            }, t.prototype.error = function() {
                for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                this.t && I(function() {
                    $.console.error(G + "[Error]: " + t.join(" "))
                })
            }, t
        }();
    $.__SENTRY__ = $.__SENTRY__ || {};
    var z, V = $.__SENTRY__.logger || ($.__SENTRY__.logger = new J),
        K = function() {
            function t() {
    ...
    function Y(t) {
        ...
        if (b(t)) {
            ...
            o.type = i.type;
            try {
                o.target = w(i.target) ? M(i.target) : Object.prototype.toString.call(i.target)
            } catch (t) {
                o.target = "<unknown>"
            }
            try {
                o.currentTarget = w(i.currentTarget) ? M(i.currentTarget) : Object.prototype.toString.call(i.currentTarget)
            } catch (t) {
    ...
    function nt(t, n) {
        return "domain" === n && t && "object" == typeof t && t.u ? "[Domain]" : "domainEmitter" === n ? "[DomainEmitter]" : "undefined" != typeof global && t === global ? "[Global]" : "undefined" != typeof window && t === window ? "[Window]" : "undefined" != typeof document && t === document ? "[Document]" : m(r = t) && "nativeEvent" in r && "preventDefault" in r && "stopPropagation" in r ? "[SyntheticEvent]" : "number" == typeof t && t != t ? "[NaN]" : void 0 === t ? "[undefined]" : "function" == typeof t ? "[Function: " + B(t) + "]" : t;
        var r
    }

    function rt(t, n, r, e) {
        if (void 0 === r && (r = 1 / 0), void 0 === e && (e = new K), 0 === r) return function(t) {
    ...
    var ot = function() {
            function t(t) {
                var n = this;
                this.s = z.PENDING, this.h = [], this.v = function(t) {
                    n.l(z.RESOLVED, t)
                }, this.p = function(t) {
                    n.l(z.REJECTED, t)
                }, this.l = function(t, r) {
                    ...
                    if (n.s !== z.PENDING) {
                        ...
                        n.h = [], t.forEach(function(t) {
                            t.done || (n.s === z.RESOLVED && t.onfulfilled && t.onfulfilled(n.m), n.s === z.REJECTED && t.onrejected && t.onrejected(n.m), t.done = !0)
                        })
                    }
                };
                try {
        ...
        ut = function() {
            ...
            return t.prototype.isReady = function() {
                ...
                var n = this;
                return this.isReady() ? (-1 === this.S.indexOf(t) && this.S.push(t), t.then(function() {
                    return n.remove(t)
                }).then(null, function() {
                    return n.remove(t).then(null, function() {})
                }), t) : ot.reject(new h("Not adding Promise due to buffer limit reached."))
    ...
    function dt(t) {
        if (!lt[t]) switch (lt[t] = !0, t) {
            case "console":
                ! function() {
                    if (!("console" in ht)) return;
                    ["debug", "info", "warn", "error", "log", "assert"].forEach(function(t) {
                        t in ht.console && Q(ht.console, t, function(n) {
                            return function() {
            ...
            case "dom":
                ! function() {
                    ...
                    ht.document.addEventListener("click", jt("click", yt.bind(null, "dom")), !1), ht.document.addEventListener("keypress", kt(yt.bind(null, "dom")), !1), ["EventTarget", "Node"].forEach(function(t) {
                        var n = ht[t] && ht[t].prototype;
                        n && n.hasOwnProperty && n.hasOwnProperty("addEventListener") && (Q(n, "addEventListener", function(t) {
                            return function(n, r, e) {
                                return r && r.handleEvent ? ("click" === n && Q(r, "handleEvent", function(t) {
                                    return function(n) {
                                        return jt("click", yt.bind(null, "dom"))(n), t.call(this, n)
                                    }
                                }), "keypress" === n && Q(r, "handleEvent", function(t) {
                                    return function(n) {
                                        return kt(yt.bind(null, "dom"))(n), t.call(this, n)
                                    }
                                })) : ("click" === n && jt("click", yt.bind(null, "dom"), !0)(this), "keypress" === n && kt(yt.bind(null, "dom"))(this)), t.call(this, n, r, e)
                            }
                    ...
                    Q(t, "open", function(t) {
                        return function() {
                            ...
                            return this.__sentry_xhr__ = {
                                ...
                                url: n[1]
                            }, p(e) && "POST" === this.__sentry_xhr__.method && e.match(/sentry_key/) && (this.__sentry_own_request__ = !0), t.apply(this, n)
                        }
                    }), Q(t, "send", function(t) {
                        return function() {
                            for (var n = [], r = 0; r < arguments.length; r++) n[r] = arguments[r];
                            ...
                            return yt("xhr", e({}, o)), i.addEventListener("readystatechange", function() {
                                if (4 === i.readyState) {
                                    try {
                ...
                ! function() {
                    if (! function() {
                            ...
                            if (r && "function" == typeof r.createElement) try {
                                ...
                                e.hidden = !0, r.head.appendChild(e), e.contentWindow && e.contentWindow.fetch && (n = at(e.contentWindow.fetch)), r.head.removeChild(e)
                            } catch (t) {
                    ...
                    Q(ht, "fetch", function(t) {
                        return function() {
                            ...
                            return yt("fetch", e({}, i)), t.apply(ht, n).then(function(t) {
                                return yt("fetch", e({}, i, {
                                    endTimestamp: Date.now(),
                                    response: t
                                })), t
            ...
            case "history":
                ! function() {
                    if (t = O(), n = t.chrome, r = n && n.app && n.app.runtime, e = "history" in t && !!t.history.pushState && !!t.history.replaceState, r || !e) return;
                    var t, n, r, e;
                    var i = ht.onpopstate;
                    ...
                    }, Q(ht.history, "pushState", o), Q(ht.history, "replaceState", o)
                }();
                break;
            case "error":
                St = ht.onerror, ht.onerror = function(t, n, r, e, i) {
                    return yt("error", {
                        column: e,
                        error: i,
                        line: r,
            ...
            case "unhandledrejection":
                Tt = ht.onunhandledrejection, ht.onunhandledrejection = function(t) {
                    return yt("unhandledrejection", t), !Tt || Tt.apply(this, arguments)
                };
                break;
            default:
    ...
    function pt(t) {
        t && "string" == typeof t.type && "function" == typeof t.callback && (vt[t.type] = vt[t.type] || [], vt[t.type].push(t.callback), dt(t.type))
    }
    ...
    function mt(t) {
        return void 0 === t && (t = []), "Request" in ht && E(t[0], Request) && t[0].method ? String(t[0].method).toUpperCase() : t[1] && t[1].method ? String(t[1].method).toUpperCase() : "GET"
    }

    function bt(t) {
        return void 0 === t && (t = []), "string" == typeof t[0] ? t[0] : "Request" in ht && E(t[0], Request) ? t[0].url : String(t[0])
    }
    var wt, gt, Et = 1e3,
        xt = 0;
    ...
    function jt(t, n, r) {
        return void 0 === r && (r = !1),
            function(e) {
                wt = void 0, e && gt !== e && (gt = e, xt && clearTimeout(xt), r ? xt = setTimeout(function() {
                    n({
                        event: e,
                        name: t
                    })
    ...
    function kt(t) {
        return function(n) {
            ...
            var e = r && r.tagName;
            e && ("INPUT" === e || "TEXTAREA" === e || r.isContentEditable) && (wt || jt("input", t)(n), clearTimeout(wt), wt = setTimeout(function() {
                wt = void 0
            }, Et))
        }
    }
        ...
        _t = function() {
            ...
            return t.prototype.toString = function(t) {
                ...
                var r = o(n.slice(1), 6),
                    ...
                    l = r[5],
                    d = l.split("/");
                d.length > 1 && (v = d.slice(0, -1).join("/"), l = d.pop()), this.O({
                    host: a,
                    pass: c,
                    path: v,
                    projectId: l,
                ...
                if (["protocol", "user", "host", "projectId"].forEach(function(n) {
                        if (!t[n]) throw new h("Invalid Dsn")
                    }), "http" !== this.protocol && "https" !== this.protocol) throw new h("Invalid Dsn");
                if (this.port && isNaN(parseInt(this.port, 10))) throw new h("Invalid Dsn")
            }, t
        }(),
        Dt = function() {
            function t() {
            ...
            return t.prototype.addScopeListener = function(t) {
                ...
                var o = this;
                return void 0 === i && (i = 0), new ot(function(u, c) {
                    var a = t[i];
                    if (null === n || "function" != typeof a) u(n);
                    else {
                        var s = a(e({}, n), r);
                        g(s) ? s.then(function(n) {
                            return o.L(t, n, r, i + 1).then(u)
                        }).then(null, c) : o.L(t, s, r, i + 1).then(u).then(null, c)
                    }
                })
                ...
                var r = new t;
                return n && (r.N = u(n.N), r.M = e({}, n.M), r.A = e({}, n.A), r.q = e({}, n.q), r.C = n.C, r.F = n.F, r.X = n.X, r.P = n.P, r.H = n.H, r.I = u(n.I)), r
                ...
                return n instanceof t ? (this.M = e({}, this.M, n.M), this.A = e({}, this.A, n.A), this.q = e({}, this.q, n.q), n.C && (this.C = n.C), n.F && (this.F = n.F), n.H && (this.H = n.H)) : m(n) && (n = n, this.M = e({}, this.M, n.tags), this.A = e({}, this.A, n.extra), this.q = e({}, this.q, n.contexts), n.user && (this.C = n.user), n.level && (this.F = n.level), n.fingerprint && (this.H = n.fingerprint)), this
            }, t.prototype.clear = function() {
                return this.N = [], this.M = {}, this.A = {}, this.C = {}, this.q = {}, this.F = void 0, this.P = void 0, this.H = void 0, this.X = void 0, this.U(), this
                ...
                return this.A && Object.keys(this.A).length && (t.extra = e({}, this.A, t.extra)), this.M && Object.keys(this.M).length && (t.tags = e({}, this.M, t.tags)), this.C && Object.keys(this.C).length && (t.user = e({}, this.C, t.user)), this.q && Object.keys(this.q).length && (t.contexts = e({}, this.q, t.contexts)), this.F && (t.level = this.F), this.P && (t.transaction = this.P), this.W(t), t.breadcrumbs = u(t.breadcrumbs || [], this.N), t.breadcrumbs = t.breadcrumbs.length > 0 ? t.breadcrumbs : void 0, this.L(u(Rt(), this.I), t, n)
            }, t
        }();
    ...
    var Nt = 3,
        Ct = function() {
            function t(t, n, r) {
                void 0 === n && (n = new Dt), void 0 === r && (r = Nt), this.B = r, this.$ = [], this.$.push({
                    client: t,
                    scope: n
                })
            }
            return t.prototype.G = function(t) {
                ...
                i && i.client && i.client[t] && (n = i.client)[t].apply(n, u(r, [i.scope]))
                ...
                return this.G("captureException", t, e({}, i, {
                    event_id: r
                })), r
                ...
                return this.G("captureMessage", t, n, e({}, o, {
                    event_id: i
                })), i
            }, t.prototype.captureEvent = function(t, n) {
                var r = this.J = _();
                return this.G("captureEvent", t, e({}, n, {
                    event_id: r
                })), r
    ...
    function qt() {
        var t = Mt();
        return Ut(t) && !Lt(t).isOlderThan(Nt) || Ht(t, new Ct), S() ? function(t) {
            try {
                var n = Mt(),
                    r = n.__SENTRY__;
    ...
    function Bt(t) {
        ...
        return function(t) {
            ...
            n[t.name] = t,
                function(t) {
                    -1 === Wt.indexOf(t.name) && (t.setupOnce(It, qt), Wt.push(t.name), V.log("Integration installed: " + t.name))
                }(t)
        }), n
    }
    var $t, Gt = function() {
            ...
            return t.prototype.captureException = function(t, n, r) {
                ...
                var i = this,
                    o = r && r.event_id;
                return this.rt = !0, (y(t) ? this.ut().eventFromMessage("" + t, n, r) : this.ut().eventFromException(t, r)).then(function(t) {
                ...
                var n = this.getOptions(),
                    ...
                    o = n.maxValueLength,
                    u = void 0 === o ? 250 : o;
                void 0 === t.environment && void 0 !== r && (t.environment = r), void 0 === t.release && void 0 !== e && (t.release = e), void 0 === t.dist && void 0 !== i && (t.dist = i), t.message && (t.message = x(t.message, u));
                ...
                return !c && "number" == typeof u && Math.random() > u ? ot.reject("This event has been sampled, will not send event.") : new ot(function(i, u) {
                    e.ft(t, r, n).then(function(t) {
                        if (null !== t) {
                            ...
                            if (void 0 === a) V.error("`beforeSend` method has to return `null` or a valid event.");
                                ...
                                if (null === (r = a)) return V.log("`beforeSend` returned `null`, will not send event."), void i(null);
                                e.dt(r), i(r)
                            }
    ...
    var Kt = function() {
        ...
        Yt = function() {
            ...
            return t.prototype.setupOnce = function() {
                ...
                return void 0 === n && (n = {}), !(!n.ignoreErrors || !n.ignoreErrors.length) && this.Tt(t).some(function(t) {
            ...
            if (n = function(t) {
                    ...
                    for (var n, r, e, i = [], o = t.stack.split("\n"), u = 0; u < o.length; ++u) {
                        if (r = nn.exec(o[u])) {
                            ...
                            r[2] && 0 === r[2].indexOf("eval") && (n = un.exec(r[2])) && (r[2] = n[1], r[3] = n[2], r[4] = n[3]), e = {
                            ...
                            r[3] && r[3].indexOf(" > eval") > -1 && (n = on.exec(r[3])) ? (r[1] = r[1] || "eval", r[3] = n[1], r[4] = n[2], r[5] = "") : 0 !== u || r[5] || void 0 === t.columnNumber || (i[0].column = t.columnNumber + 1), e = {
                                url: r[3],
                                func: r[1] || tn,
                                args: r[2] ? r[2].split(",") : [],
                                line: r[4] ? +r[4] : null,
    ...
    function dn(t, n, r) {
        ...
        return v(t) ? e = vn(cn(t)) : m(t) || b(t) ? (C(e = function(t, n, r) {
            var e = {
                exception: {
                    values: [{
    ...
    var yn = function() {
            function t(t) {
                this.options = t, this.S = new ut(30), this.Ot = new Xt(this.options.dsn), this.url = this.Ot.getStoreEndpointWithUrlEncodedAuth()
            }
        ...
        bn = function(n) {
            ...
            return r(e, n), e.prototype.sendEvent = function(n) {
                var r = this;
                if (new Date(Date.now()) < this._t) return Promise.reject({
                    event: n,
                ...
                return void 0 !== this.options.headers && (i.headers = this.options.headers), this.S.add(new ot(function(n, o) {
                    mn.fetch(e.url, i).then(function(e) {
                        var i = t.Status.fromHttpCode(e.status);
                        if (i !== t.Status.Success) {
                            if (i === t.Status.RateLimit) {
                                var u = Date.now();
                                r._t = new Date(u + X(u, e.headers.get("Retry-After"))), V.warn("Too many requests, backing off till: " + r._t)
                            }
                            o(e)
                        } else n({
                            status: i
        ...
        wn = function(n) {
            ...
            return r(e, n), e.prototype.sendEvent = function(n) {
                ...
                var e = Vt(n, this.Ot);
                return this.S.add(new ot(function(n, i) {
                            ...
                            if (4 === o.readyState) {
                                ...
                                if (e !== t.Status.Success) {
                                    if (e === t.Status.RateLimit) {
                                        var u = Date.now();
                                        r._t = new Date(u + X(u, o.getResponseHeader("Retry-After"))), V.warn("Too many requests, backing off till: " + r._t)
                                    }
                                    i(o)
                                } else n({
                                    status: e
        ...
        En = function(n) {
            ...
            return r(i, n), i.prototype.bt = function() {
                ...
                return C(e, {
                    handled: !0,
                    type: "generic"
                }), e.level = t.Severity.Error, r && r.event_id && (e.event_id = r.event_id), ot.resolve(e)
            }, i.prototype.eventFromMessage = function(n, r, e) {
                void 0 === r && (r = t.Severity.Info);
                var i = pn(n, e && e.syntheticException || void 0, {
                    attachStacktrace: this.it.attachStacktrace
                });
                return i.level = r, e && e.event_id && (i.event_id = e.event_id), ot.resolve(i)
            }, i
        }(zt),
        xn = 0;
    ...
    function kn(t, n, r) {
        ...
        var sentryWrapped = function() {
            ...
            try {
                ...
                throw xn += 1, setTimeout(function() {
                    xn -= 1
                }), Pt(function(r) {
                    r.addEventProcessor(function(t) {
                        var r = e({}, t);
                        return n.mechanism && (N(r, void 0, void 0), C(r, n.mechanism)), r.extra = e({}, r.extra, {
                            arguments: i
                        }), r
                    }), captureException(t)
                }), t
    ...
    var Sn = function() {
            function n(t) {
                this.name = n.id, this.Dt = !1, this.Rt = !1, this.it = e({
                    onerror: !0,
                    onunhandledrejection: !0
                }, t)
            }
            return n.prototype.setupOnce = function() {
                Error.stackTraceLimit = 50, this.it.onerror && (V.log("Global Handler attached: onerror"), this.It()), this.it.onunhandledrejection && (V.log("Global Handler attached: onunhandledrejection"), this.Nt())
                ...
                this.Dt || (pt({
                    callback: function(r) {
                        ...
                        if (o && !jn() && !u) {
                            var c = i.getClient(),
                                a = y(e) ? t.Ct(r.msg, r.url, r.line, r.column) : t.Mt(dn(e, void 0, {
                ...
                this.Rt || (pt({
                    callback: function(e) {
                        ...
                        if (!u || jn() || c) return !0;
                        var a = o.getClient(),
                            s = y(i) ? r.At(i) : dn(i, void 0, {
                                attachStacktrace: a && a.getOptions().attachStacktrace,
                                rejection: !0
                            });
                        s.level = t.Severity.Error, C(s, {
                            handled: !1,
        ...
        On = function() {
            ...
            return t.prototype.qt = function(t) {
                ...
                var n = O(),
                    r = n[t] && n[t].prototype;
                r && r.hasOwnProperty && r.hasOwnProperty("addEventListener") && (Q(r, "addEventListener", function(n) {
                    return function(r, e, i) {
                        try {
                            "function" == typeof e.handleEvent && (e.handleEvent = kn(e.handleEvent.bind(e), {
                                mechanism: {
                                    data: {
                ...
                return function() {
                    ...
                    return ["onload", "onerror", "onprogress", "onreadystatechange"].forEach(function(t) {
                        t in e && "function" == typeof e[t] && Q(e, t, function(n) {
                            var r = {
                                mechanism: {
                                    data: {
                                        function: t,
                            ...
                            return n.__sentry_original__ && (r.mechanism.data.handler = B(n.__sentry_original__)), kn(n, r)
                        })
                    }), t.apply(this, n)
                }
            }, t.prototype.setupOnce = function() {
                var t = O();
                (this.it.setTimeout && Q(t, "setTimeout", this.qt.bind(this)), this.it.setInterval && Q(t, "setInterval", this.qt.bind(this)), this.it.requestAnimationFrame && Q(t, "requestAnimationFrame", this.Ut.bind(this)), this.it.XMLHttpRequest && "XMLHttpRequest" in t && Q(XMLHttpRequest.prototype, "send", this.Ht.bind(this)), this.it.eventTarget) && (Array.isArray(this.it.eventTarget) ? this.it.eventTarget : Tn).forEach(this.Lt.bind(this))
            }, t.id = "TryCatch", t
        }(),
        _n = function() {
            function n(t) {
                this.name = n.id, this.it = e({
                    console: !0,
                    dom: !0,
                    fetch: !0,
                    history: !0,
            ...
            return n.prototype.addSentryBreadcrumb = function(t) {
                this.it.sentry && qt().addBreadcrumb({
                ...
                n.endTimestamp && (n.fetchData.url.match(/sentry_key/) && "POST" === n.fetchData.method || (n.error ? qt().addBreadcrumb({
                    category: "fetch",
                    data: n.fetchData,
                ...
                var n = O(),
                    ...
                    o = D(r),
                    u = D(e);
                o.path || (o = i), i.protocol === u.protocol && i.host === u.host && (e = u.relative), i.protocol === o.protocol && i.host === o.host && (r = o.relative), qt().addBreadcrumb({
                    category: "navigation",
                    data: {
                        from: r,
                        to: e
        ...
        In = function() {
            function t(n) {
                void 0 === n && (n = {}), this.name = t.id, this.$t = n.key || Dn, this.k = n.limit || Rn
            }
            return t.prototype.setupOnce = function() {
                It(function(n, r) {
                ...
                var r = this.Jt(n.originalException, this.$t);
            ...
            return t.prototype.setupOnce = function() {
                It(function(n) {
                    if (qt().getIntegration(t)) {
                        ...
                        var r = n.request || {};
                        return r.url = r.url || Nn.location.href, r.headers = r.headers || {}, r.headers["User-Agent"] = Nn.navigator.userAgent, e({}, n, {
                            request: r
                        })
                    }
                    return n
        ...
        qn = function(t) {
            ...
            return r(n, t), n.prototype.ft = function(n, r, i) {
                return n.platform = n.platform || "javascript", n.sdk = e({}, n.sdk, {
                    name: An,
                    ...
                    if (this.st()) {
                        ...
                        if (t.eventId)
                            if (r) {
                                ...
                                e.async = !0, e.src = new Xt(r).getReportDialogEndpoint(t), t.onLoad && (e.onload = t.onLoad), (n.head || n.body).appendChild(e)
    ...
    var Fn = e({}, Ln, Zt, Mn);
    return t.BrowserClient = qn, t.Hub = Ct, t.Integrations = Fn, t.SDK_NAME = An, t.SDK_VERSION = "5.16.1", t.Scope = Dt, t.Transports = gn, t.addBreadcrumb = function(t) {
        Ft("addBreadcrumb", t)
        ...
        return Ft("captureMessage", t, "string" == typeof n ? n : void 0, e({
            originalException: t,
            syntheticException: r
        }, "string" != typeof n ? {
            captureContext: n
        ...
        Ft("configureScope", t)
    }, t.defaultIntegrations = Un, t.flush = function(t) {
        var n = qt().getClient();
        return n ? n.flush(t) : ot.reject(!1)
    }, t.forceLoad = function() {}, t.getCurrentHub = qt, t.getHubFromCarrier = Lt, t.init = function(t) {
    ...
    }, t.withScope = Pt, t.wrap = function(t) {
        return kn(t)()
    }, t
}({});
